...
CLAUSES = [
    ...
    ("第十三条 个人信息处理与跨境传输",
     "13.1 乙方为向甲方提供服务所必需，可将甲方提供的员工账号、邮箱、手机号及访问日志存储于境外服务器。\n"
     "13.2 跨境传输前乙方无需单独取得甲方或个人信息主体的同意，甲方在服务期内使用即视为概括授权。\n"
     "13.3 乙方可就上述个人信息与任意关联公司及合作方共享，无需逐次告知。"),
    ("第十四条 暂停服务",
    ...
    ("第十七条 不可抗力",
     "17.1 不可抗力包括网络攻击、病毒、云服务商或基础软件供应商故障。"),
    ("第十八条 通知与电子证据",
     "18.1 乙方向管理后台发送信息后即视为送达。"),
    ("第十九条 法律适用与争议解决",
     "19.1 协商不成的，任何一方均应向乙方住所地有管辖权的人民法院提起诉讼。"),
    ("第二十条 其他",
     "20.1 乙方可将本合同转让给其关联公司或业务承继方，并通知甲方。"),
]
